...
import { customTooltips } from '../../../utils/customTooltips';
...
function DashboardChart({ type, height, width, scales, labels, id, datasets, tooltip, layout, legend, elements, option, ...props }) {
  useEffect(() => {
    let chart = null;
    let unmounted = false;
    if (!unmounted) {
